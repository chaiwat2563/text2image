...
export const LoadingSpinner: React.FC<{ className?: string }> = ({ className = 'w-12 h-12' }) => (
  <svg
    className={`animate-spin text-purple-400 ${className}`}
...
export const ErrorIcon: React.FC<{ className?: string }> = ({ className = 'w-12 h-12' }) => (
...
export const NewImageIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
